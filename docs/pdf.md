...
<p>Desenvolvedor Full Stack com 10 anos de experiência, atuando no desenvolvimento de integrações de API e aplicações web. Possui mais de sete anos de experiência na área de desenvolvimento, com competência no gerenciamento de todas as etapas do ciclo de desenvolvimento — desde a coleta de requisitos e prototipação até a implantação e manutenção —, realizando todos os testes necessários para garantir a funcionalidade e a qualidade do produto.</p>
...
<ul class="custom-ul">
    ...
    <li>Melhoria e entregas contínuas com processos de CI/CD</li>   
</ul>
...
<div class="row">
 <div class="col">
    <ul class="custom-ul">
            ...
            <li>SQL Server, Oracle, MySQL e PostgreSQL:Criação e manutenção de DBs, Workbench e Queries</li>
 ...
 <div class="col">
    <ul class="custom-ul">
        ...
        <li>Experiência em produtos Web: Intranets,portais e integrações entre sistemas WEB</li> 
        <li>Experiência com CI/CD utilizando Jenkins e Gitlab CI</li>           
    </ul>
 </div>
</div>
</div>